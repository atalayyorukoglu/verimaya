...
describe('IDEM-01: every mutating endpoint declares an idempotency policy', () => {
	...
	it('the reflection walk actually finds handlers (guards the other assertions against passing vacuously)', () => {
		expect(handlers.length).toBe(141);
	});
	...
	it('exactly the endpoints wired through IdempotencyService.run() are marked enforced', () => {
		...
		expect(enforced).toEqual(
			[
				...
				'ContactsController.deleteFile',
				'ContactsController.createCaseNote',
				'ContactsController.deleteCaseNote',
				'ContactsController.createVisit',
				'ContactsController.updateVisit',
				'ContactsController.deleteVisit',
				...
				'OperationAlertsController.create',
				'OperationAlertsController.confirm',
				'OperationAlertsController.remove',
				'IncidentsController.create',
				'IncidentsController.resolve',
				'IncidentsController.remove',
				'RecordSuggestionsController.approve',
				'RecordSuggestionsController.reject',
				'ContactVisitSuggestionsController.approve',
				'ContactVisitSuggestionsController.approveAll',
				'ContactVisitSuggestionsController.reject',
				'ContactVisitSuggestionsController.rejectAll',
				...
				'WhatsappController.createContactFromMessage',
				'WhatsappController.createCategory',
				'WhatsappController.reclassifyMedia',
				'WhatsappController.reprocessVisits',
				'WhatsappController.updateMedia',
				...
				'SettingsController.createIncidentType',
				'SettingsController.createOrganization',
				'SettingsController.createAppointmentType',
				'SettingsController.putPatientFlow',
				'ImportExportController.contactsCommit',
				'ImportExportController.bundleCommit',
