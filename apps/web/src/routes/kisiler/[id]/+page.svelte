...
<div class="mx-auto max-w-3xl min-w-0">
	<a href="/kisiler" class="mb-4 inline-block text-sm text-info hover:underline">← Kişiler</a>
	...
	{:else}
		...
		{#if linkedPatient}
			<section class="mb-4 rounded-lg border border-border bg-surface p-4">
				...
				<a href={`/hastalar/${linkedPatient.id}`} class="text-sm font-medium text-brand hover:underline">
		...
		<section class="mb-4 rounded-lg border border-border bg-surface p-4">
			<div class="mb-3 flex items-center justify-between gap-2">
				...
				<a href={`/finans/bakiyeler`} class="text-xs text-brand hover:underline">Bakiyeler →</a>
			</div>
