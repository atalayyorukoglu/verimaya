...
const tr = {
	...
	'patients.list.description': 'Operasyon dosyaları — randevu, dosya ve finans bu kayıtta toplanır.',
	'patients.list.searchPlaceholder': 'Ad, e-posta veya telefon…',
	'patients.list.search': 'Ara',
	'patients.list.scanDuplicates': 'Çift kayıt tara',
	'patients.list.newPatient': 'Yeni dosya',
	'patients.list.loading': 'Yükleniyor…',
	'patients.list.loadError': 'Hasta listesi yüklenemedi.',
	'patients.list.emptyTitle': 'Operasyon dosyası bulunamadı',
	'patients.list.emptyDescription': 'Yeni dosya açın veya arama filtresini değiştirin.',
	'patients.list.emptyDescriptionDemo': 'Yeni dosya açın veya demo senaryosunu değiştirin.',
	...
	'patients.duplicates.description':
		'Aynı telefon, e-posta veya adla birden fazla operasyon dosyası.',
	'patients.form.editTitle': 'Dosyayı düzenle',
	'patients.form.createTitle': 'Yeni operasyon dosyası',
	'patients.form.description': 'Randevu ve finans bu dosyada izlenir.',
	'patients.form.descriptionDemo': 'Demo modunda MSW üzerinden kaydedilir.',
	'patients.form.name': 'Ad soyad',
	'patients.form.phone': 'Telefon',
	'patients.form.email': 'E-posta',
	'patients.form.status': 'Operasyon durumu',
	...
	'panel.home.activeFiles': 'Aktif dosya',
	'panel.home.activeFilesHint': 'Kapanmamış operasyon',
	'panel.home.todayAppointments': 'Bugün randevu',
	'panel.home.todayHint': 'Bugün',
	'panel.home.waPending': 'WA bekleyen',
	'panel.home.waHint': 'AI ile işlem',
	'panel.home.waNoAccess': 'Yetki yok',
	'panel.home.netMonth': 'Net (bu ay)',
	'panel.home.netServer': 'Sunucu aggregate',
	'panel.home.metrics': 'Özet metrikler',

	'reports.ops.statusDistribution': 'Operasyon dosyası durumu',
	'reports.ops.statusEmpty': 'Operasyon dosyası yok.',
	'reports.ops.sourceDistribution': 'Kaynak dağılımı (pazarlama)',
	'reports.ops.sourceEmpty': 'Kaynak verisi yok.',
	'reports.appointments.title': 'Randevu operasyon metrikleri',
	'reports.appointments.total': 'Toplam randevu',
	'reports.appointments.completionRate': 'Tamamlanma oranı',
	'reports.appointments.noShowRate': 'Gelmedi oranı',
	'reports.appointments.cancellationRate': 'İptal oranı',
	'reports.appointments.byStatus': 'Durum dağılımı',
	'reports.appointments.byType': 'Randevu tipi dağılımı',
	'reports.appointments.byClinic': 'Klinik performansı',
	'reports.appointments.byMonth': 'Aylık randevu trendi',
	'reports.appointments.empty': 'Seçili dönemde randevu yok.',
	...
	'settings.team.inviteDisabled': 'Davet akışı Faz 0b\'de (better-auth organization)',
	...
	'settings.team.roleSaveError': 'Rol güncellenemedi',
	'settings.team.footnote':
		'Rol değiştirme org sahibi ve yöneticiler içindir. Kendi rolünüzü değiştiremezsiniz.',

	'finance.filters.search': 'Ara',
	'finance.filters.searchPlaceholder': 'Başlık, hasta veya kategori…',
	'finance.filters.kind': 'Tür',
	'finance.filters.kindAll': 'Tüm türler',
	'finance.filters.status': 'Durum',
	'finance.filters.statusAll': 'Tüm durumlar',
	'finance.filters.category': 'Kategori',
	'finance.filters.categoryAll': 'Tüm kategoriler',
...
const en: Record<MessageKey, string> = {
	...
	'patients.list.description':
		'Operation files — appointments, documents, and finance are tracked per file.',
	'patients.list.searchPlaceholder': 'Name, email, or phone…',
	'patients.list.search': 'Search',
	'patients.list.scanDuplicates': 'Scan duplicates',
	'patients.list.newPatient': 'New file',
	'patients.list.loading': 'Loading…',
	'patients.list.loadError': 'Could not load patient list.',
	'patients.list.emptyTitle': 'No operation files found',
	'patients.list.emptyDescription': 'Open a new file or change your search filter.',
	'patients.list.emptyDescriptionDemo': 'Open a new file or switch the demo scenario.',
	...
	'patients.duplicates.description':
		'Multiple operation files with the same phone, email, or name.',
	'patients.form.editTitle': 'Edit file',
	'patients.form.createTitle': 'New operation file',
	'patients.form.description': 'Appointments and finance are tracked in this file.',
	'patients.form.descriptionDemo': 'Saved via MSW in demo mode.',
	'patients.form.name': 'Full name',
	'patients.form.phone': 'Phone',
	'patients.form.email': 'Email',
	'patients.form.status': 'Operation status',
	...
	'panel.home.activeFiles': 'Active files',
	'panel.home.activeFilesHint': 'Open operations',
	'panel.home.todayAppointments': "Today's appointments",
	'panel.home.todayHint': 'Today',
	'panel.home.waPending': 'WA pending',
	'panel.home.waHint': 'AI transaction',
	'panel.home.waNoAccess': 'No access',
	'panel.home.netMonth': 'Net (this month)',
	'panel.home.netServer': 'Server aggregate',
	'panel.home.metrics': 'Summary metrics',

	'reports.ops.statusDistribution': 'Operation file status',
	'reports.ops.statusEmpty': 'No operation files.',
	'reports.ops.sourceDistribution': 'Source distribution (marketing)',
	'reports.ops.sourceEmpty': 'No source data.',
	'reports.appointments.title': 'Appointment operations metrics',
	'reports.appointments.total': 'Total appointments',
	'reports.appointments.completionRate': 'Completion rate',
	'reports.appointments.noShowRate': 'No-show rate',
	'reports.appointments.cancellationRate': 'Cancellation rate',
	'reports.appointments.byStatus': 'Status distribution',
	'reports.appointments.byType': 'Appointment type distribution',
	'reports.appointments.byClinic': 'Clinic performance',
	'reports.appointments.byMonth': 'Monthly appointment trend',
	'reports.appointments.empty': 'No appointments in the selected period.',
	...
	'settings.team.inviteDisabled': 'Invite flow ships in Phase 0b (better-auth organization)',
	'settings.team.invite': 'Invite member',
	'settings.team.loading': 'Loading…',
	'settings.team.loadError': 'Could not load team list.',
	'settings.team.empty': 'No members.',
	'settings.team.joined': 'Joined',
	'settings.team.roleLabel': 'Role',
	'settings.team.roleSaveError': 'Could not update role',
	'settings.team.footnote':
		'Role changes are for org owners and admins. You cannot change your own role.',

	'finance.filters.search': 'Search',
	'finance.filters.searchPlaceholder': 'Title, patient, or category…',
	'finance.filters.kind': 'Type',
	'finance.filters.kindAll': 'All types',
	'finance.filters.status': 'Status',
	'finance.filters.statusAll': 'All statuses',
